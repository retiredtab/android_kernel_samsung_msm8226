...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p1[] = {
	...
	{ 1,  192000, ACPUPLL, 5, 2,   CPR_FUSE_CORNER_SVS,      0, 4 },
	{ 1,  249600, ACPUPLL, 5, 2,   CPR_FUSE_CORNER_SVS,      0, 4 },
#endif
	{ 1,  300000, PLL0,    4, 2,   CPR_FUSE_CORNER_SVS,      0, 4 },
	{ 1,  384000, ACPUPLL, 5, 2,   CPR_FUSE_CORNER_SVS,      0, 4 },
	{ 1,  600000, PLL0,    4, 0,   CPR_FUSE_CORNER_NORMAL,   0, 6 },
	{ 1,  787200, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_NORMAL,   0, 6 },
	{ 1,  998400, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 7 },
	{ 1, 1094400, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 7 },
	{ 1, 1190400, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 7 },
	{ 1, 1305600, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 8 },
	{ 1, 1344000, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 8 },
	{ 1, 1401600, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 9 },
	{ 1, 1497600, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 9 },
	{ 1, 1593600, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 9 },
	{ 0 }
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p2[] = {
	...
	{ 1,  787200, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_NORMAL,   0, 6 },
	{ 1,  998400, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 7 },
	{ 1, 1094400, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 8 },
	{ 1, 1190400, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 9 },
	{ 0 }
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p4[] = {
	...
	{ 1,  998400, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 7 },
	{ 1, 1094400, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 7 },
	{ 1, 1190400, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 8 },
	{ 1, 1305600, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 8 },
	{ 1, 1344000, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 9 },
	{ 1, 1401600, ACPUPLL, 5, 0,   CPR_FUSE_CORNER_TURBO,    0, 9 },
	{ 0 }
};
...
static struct acpuclk_drv_data drv_data = {
	...
	.vdd_max_cpu = 1280000,
#else
 	.vdd_max_cpu = CPR_FUSE_CORNER_TURBO,
#endif
	.src_clocks = {
		[PLL0].name = "gpll0",
